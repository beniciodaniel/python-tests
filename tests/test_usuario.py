...
def test_que_deve_permitir_propor_lance_quando_valor_eh_igual_ao_valor_da_carteira():
    vini = Usuario("Vini", 100.0)
    leilao = Leilao("Celular")
...
def test_onde_nao_deve_permitir_propor_lance_com_valor_maior_que_o_da_carteira():
    vini = Usuario("Vini", 100.0)
    leilao = Leilao("celular")
